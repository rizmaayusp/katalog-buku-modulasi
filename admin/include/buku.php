            ...
            <div class="card">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      if (isset($katakunci_buku) && !empty($katakunci_buku)) {
                        $sql_b .= " WHERE `b`.`Judul` LIKE '%$katakunci_buku%' || `k`.`kategori_buku` LIKE '%$katakunci_buku%'";
                      }
              ...
              <?php
                ...
                if (isset($katakunci_buku)) {
                  $sql_jum .= " WHERE `b`.`Judul` LIKE '%$katakunci_buku%' || `k`.`kategori_buku` LIKE '%$katakunci_buku%'";
                }
